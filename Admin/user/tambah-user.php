...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <input type="text" name="nama_user" size="30">
    </div>
  </div>
  <div class="row mb-3">
...
if(isset($_POST['proses'])){
    ...
    mysqli_query($connect, "INSERT INTO tb_user(id_user, nama_user, username, password) VALUES ('', '$nama_user', '$username', '$password')") or die (mysqli_error($connect));
