   ...
   <body>
    ...
    <div class="container">
        ...
        <div class="pull-right">
                ...
                &ensp;
                <a href="tambah-obat-pend.php" class="button2"><i class="glyphicon glyphicon-plus"></i>Tambah Obat</a>      
            </div>
        </h4>
        <div class="pull-left">
                &ensp;&ensp;  
        ...
        while($row = mysqli_fetch_array($ambildata)){
            ...
            <tr>
                ...
                <td>$row[nama_obat]</td>
                <td>$row[stok_obat]</td>
                <td><a href='edit-obat-pend.php?kode=$row[id_obat]' class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span> Ubah</a></td>
            <tr>";
            $no++;
        }
        ?>
        ...
        echo "<meta http-equiv=refresh content=2;URL='tampil-obat-pend.php'>";
