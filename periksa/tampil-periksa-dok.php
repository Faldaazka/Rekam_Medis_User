   ...
   <body>
    ...
    <div class="container">
        ...
        <div class="pull-left">
                ...
                &ensp;&ensp;
                <a href="../tampil-rekdis.php" type="button" class="btn btn-warning"><span class="bi bi-arrow-bar-left"></span>Rekam Medis</a>
            </div>
    </div>
    <br/>
    <br/>
    <div class="container">
        ...
        while($row = mysqli_fetch_array($sql_pendaftaran)){
            ...
            <tr>
                ...
                <td>$row[_status]</td>
                <td><a href='edit-periksa-dok.php?kode=$row[id_periksa]' class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span> Ubah</a></td>
            <tr>";
            $no++;
        }
        ?>
