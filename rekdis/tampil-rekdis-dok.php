...
<body>
    <div class="container">
        ...
        <div class="container">
            <h4>
                <div class="pull-right">
                    ...
                    &ensp;
                    <a href="tambah-rekdis-dok.php" class="button2"><i class="glyphicon glyphicon-plus"></i>Tambah Rekam Medis</a>
                </div>
            </h4>
            <div class="pull-left">
                &ensp;&ensp;
        ...
        if (isset($_GET['kode'])) {
            ...
            echo "<meta http-equiv=refresh content=2;URL='tampil-rekdis-dok.php'>";
        }
        ?>
    </div>
