...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
   ...
   <body>
    <div class="container">
    <h1 align="center"><strong>Rekam Medis</strong></h1>
    <br/>
    ...
    <div class="container">
        ...
        <div class="pull-right">
                ...
                &ensp;
                <a href="tambah-rekdis.php" class="button2"><i class="glyphicon glyphicon-plus"></i>Tambah Rekam Medis</a>      
            </div>
        </h4>
        <div class="pull-left">
                &ensp;&ensp;  
        ...
        <table class="table table table-striped table-hover table table-bordered" id="rekammedis">
        <thead class="">
        <tr>
            <th>No.</th>
            <th >Nama Pasien</th>
        ...
        while($row = mysqli_fetch_array($sql_rekdis)){ ?>
            <tr>
                ...
                <td><a href='edit-rekdis.php?kode=$row[id_rekam_medis]' class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span> Ubah</a></td>
            <tr>
            <?php
            }
            ?>
        ...
        echo "<meta http-equiv=refresh content=2;URL='tampil-rekdis.php'>";
