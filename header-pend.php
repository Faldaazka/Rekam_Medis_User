  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="active"><a href="<?=base_url('dashboard')?>">Beranda</a></li>
          ...
          <li class="dropdown"><a href="#"><span>Dokter</span> <i class="bi bi-chevron-down"></i></a>
            ...
            <li><a class="nav-link scrollto" href="active"><a href="<?=base_url('dokter/tampil-dokter.php')?>">Jadwal Dokter</a></li>
            </ul>
          <li><a class="nav-link scrollto" href="active"><a href="<?=base_url('pasien/tampil-pasien1.php')?>">Pasien</a></li>
