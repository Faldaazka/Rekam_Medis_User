...
$sql=mysqli_query($connect, "SELECT * FROM dokter WHERE id_dokter='$_GET[kode]'");
...
<div class="container">
<h3><strong>Tambah Dokter</h3><br/>
<form action="" method="post">
<div class="row mb-3">
    <label class="col-sm-2 col-form-label">Nama Dokter</label>
    <div class="col-sm-10">
        <input type="text" name="nama_dokter" size="30" value="<?php echo $data['nama_dokter']; ?>">
    </div>
  </div>
  <div class="row mb-3">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
        <input type="date" name="tgl_lahir_dokter" size="30" value="<?php echo $data['tgl_lahir_dokter']; ?>">
    </div>
  </div>
  <div class="row mb-3">
    <label class="col-sm-2 col-form-label">Telephone</label>
    <div class="col-sm-10">
      <input type="text" name="no_tlp_dokter" size="30" value="<?php echo $data['no_tlp_dokter']; ?>">
    </div>
  </div>
  <div class="row mb-3">
