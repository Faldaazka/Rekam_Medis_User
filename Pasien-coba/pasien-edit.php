      ...
      <div class="card-body">
        <form action="" method="post">
         <div class="row mb-3">
            ...
            <div class="col-sm-5">
              <input type="text" name="id_pasien" class="form-control" id="id_pasien" value="<?=$pasien["id_pasien"]; ?>">
            </div>
          </div>
          <div class="row mb-3">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-5">
              <input type="date" name="tgl_lahir" class="form-control" id="tgl_lahir" value="<?=$pasien["tanggal_lahir"]; ?>">
            </div>
        <div class="row mb-3">
            <label for="no_tlp_pasien" class="col-sm-2 col-form-label">Telephone</label>
            <div class="col-sm-5">
              <input type="text" name="no_tlp_pasien" class="form-control" id="no_tlp_pasien" value="<?=isset($pasien["no_tlp_pasien"]); ?>">
            </div>
        <div class="row mb-3">
