...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
   ...
   <h1 align="center"><strong>Daftar Obat</strong></h1>
        ...
        <div class="pull-right">
            ...
            &ensp;
            <a href="tambah-pasien-pend.php" class="button2"><i class="glyphicon glyphicon-plus"></i>Tambah Pasien</a>      
        </div>
        </h4>   
        <div class="pull-left">
                &ensp;&ensp;  
                    ...
                    if(mysqli_num_rows($sql_pasien) > 0) {
                        while($data = mysqli_fetch_array($sql_pasien)) { ?>
                            <tr>
                                ...
                                <td><a href='edit-pasien.php?kode=<?=$data['id_pasien']?>' class='btn btn-warning'><span class='glyphicon glyphicon-edit'></span> Ubah</a></td>
                                </td>
                            </tr>
                            <?php
                        }
